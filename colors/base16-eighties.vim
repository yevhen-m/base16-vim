...
" Diff highlighting
call <sid>hi("DiffAdd",     s:green,    s:black, "bold")
call <sid>hi("DiffChange",  s:mid_gray, s:black, "bold")
call <sid>hi("DiffDelete",  s:red,      s:black, "bold")
call <sid>hi("DiffText",    s:blue,     s:black, "bold")
