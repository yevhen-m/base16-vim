...
call <sid>hi("FoldColumn",   s:mid_gray,       s:black,      "")
...
call <sid>hi("WildMenu",     s:semi_dark_gray, "",               "bold")
...
call <sid>hi("StatusLineNC", s:light_gray,       s:dark_gray,      "none")
...
call <sid>hi("CursorLineNr", s:mid_gray,       s:black,      "none")
...
" Diff highlighting
call <sid>hi("DiffAdd",     s:green,    s:dark_gray, "bold")
call <sid>hi("DiffChange",  s:mid_gray, s:dark_gray, "bold")
call <sid>hi("DiffDelete",  s:red,      s:dark_gray, "bold")
call <sid>hi("DiffText",    s:blue,     s:dark_gray, "bold")
call <sid>hi("DiffAdded",   s:green,    s:dark_gray,     "")
call <sid>hi("DiffFile",    s:red,      s:dark_gray,     "")
call <sid>hi("DiffNewFile", s:green,    s:dark_gray,     "")
call <sid>hi("DiffLine",    s:blue,     s:dark_gray,     "")
call <sid>hi("DiffRemoved", s:red,      s:dark_gray,     "")
